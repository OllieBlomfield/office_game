...
## Controls
- Press Left or Right buttons to choose a direction for Jimbo to move.
- Press the X (❎) button to jump and interact with menus.

## Credits
The game was inspired by an old mobile game I used to play when I was younger called Rat on the Run. The art style also took inspiration from corporate memphis drawings and the movie Office Space. A massive thank you to all my friends and family who helped me playtest and get the game to a standard I am very happy with. I spent about 2 months all together working on the game and polishing up its many bugs. I hope you enjoy!!!
